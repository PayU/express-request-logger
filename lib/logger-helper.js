...
function getRequestAudit(req, options) {
    ...
    if (options.maxRequestBodyLength && bodyStr.length > options.maxRequestBodyLength) {
        bodyStr = bodyStr.substr(0, options.maxRequestBodyLength) + '...';
    }
...
function getResponseAudit(req, res, options) {
    ...
    if (options.maxResponseBodyLength && bodyStr.length > options.maxResponseBodyLength) {
        bodyStr = bodyStr.substr(0, options.maxResponseBodyLength) + '...';
    }
