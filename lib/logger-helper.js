...
function getRequestAudit(req, options){
    ...
    requestBody = handleBody(requestBody, options.logger, options.request.excludeBody, options.request.maskBody);
...
function handleBody(body, logger, excludeBody, maskBody) {
...
function getResponseAudit(req, res, options){
    ...
    responseBody = handleBody(responseBody, options.logger , options.response.excludeBody, options.response.maskBody);
